...
#define CS_HIGH do { GPIOA->BSRR = GPIO_BSRR_BS_15; } while(0)
#define CS_LOW do { GPIOA->BSRR = GPIO_BSRR_BR_15; } while(0)
#define RESET_NUM 3
#define RESET_BIT (1<<RESET_NUM)
#define RESET_HIGH do { GPIOA->BSRR = GPIO_BSRR_BS_3; } while(0)
#define RESET_LOW  do { GPIOA->BSRR = GPIO_BSRR_BR_3; } while(0)
#define DC_NUM 2
#define DC_BIT (1<<DC_NUM)
#define DC_HIGH do { GPIOA->BSRR = GPIO_BSRR_BS_2; } while(0)
#define DC_LOW  do { GPIOA->BSRR = GPIO_BSRR_BR_2; } while(0)
...
#define CSPORT GPIOA
#define LCD_CS    15 /* also known as NSS */
#define RSPORT GPIOA
#define LCD_RS    2
#define RESETPORT GPIOA
#define LCD_RESET 3
